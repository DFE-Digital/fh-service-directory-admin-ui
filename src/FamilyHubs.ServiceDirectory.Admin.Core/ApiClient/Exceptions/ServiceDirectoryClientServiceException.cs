...
public class ServiceDirectoryClientServiceException : Exception
{
    ...
    public ServiceDirectoryClientServiceException(HttpResponseMessage httpResponseMessage, string errorResponse)
