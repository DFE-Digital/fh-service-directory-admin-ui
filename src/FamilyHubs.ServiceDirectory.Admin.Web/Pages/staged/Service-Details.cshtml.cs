...
//todo: update prompt to allow expanding abbreviations before encountering them.
//eg "The Family Support Service (FSS) is committed to providing robust support"
// According to GDS guidelines, abbreviations should be expanded on first use.
// something like, allow abbreviation expansion before first introducing an abbreviation - give the above example
//todo: check for hallucinations : if text isn't found, don't report it - have another section 'possible hallucinations'?
...
User Content:     
    ...
    private static Dictionary<long, string> _overrides = new()
    {
        ...
        },
        {
            ...
            // gpt-4o
            "{\n\"ReadingLevel\": 10,\n\"InappropriateLanguage\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"Security\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"PoliticisedSentiment\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"PII\": {\n\"Flag\": true,\n\"Instances\": [\n{\n\"Reason\": \"Contains name of supported individual\",\n\"Content\": \"We once famously helped Oliver Reed kick his alcohol addiction!\",\n\"SuggestedReplacement\": \"We have helped many individuals overcome their alcohol addiction.\",\n\"Notes\": \"The Data Protection Act 2018 emphasizes responsible handling and protection of personal data. An individual’s name is considered identifiable.\"\n}\n]\n},\n\"GrammarAndSpelling\": {\n\"Flag\": true,\n\"Instances\": [\n{\n\"Reason\": \"Spelling\",\n\"Content\": \"dependant\",\n\"SuggestedReplacement\": \"dependent\"\n}\n]\n},\n\"StyleViolations\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"Summary\": \"The content contains a PII issue by mentioning Oliver Reed by name and a spelling mistake ('dependant' should be 'dependent'). Otherwise, the content is generally suitable for publication.\"\n}"
        },
        {
            // ! Political
            240877,
            ...
            // gpt-4o
            "{\n\"ReadingLevel\": 9,\n\"InappropriateLanguage\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"Security\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"PoliticisedSentiment\": {\n\"Flag\": true,\n\"Instances\": [\n{\n\"Reason\": \"Negative sentiment towards Conservative party\",\n\"Content\": \"Tory's disastrous and counterproductive policy of austerity\",\n\"SuggestedReplacement\": \"challenging policies regarding public spending\",\n\"Notes\": \"The negative sentiment towards a political party could alienate readers and compromise neutrality.\"\n}\n]\n},\n\"PII\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"GrammarAndSpelling\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"StyleViolations\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"Summary\": \"The content contains a negative sentiment towards a political party, which should be revised to ensure neutrality.\"\n}"
        },
        {
            // ! Security - sensitive info leak
            270878,
            // ms phi-3 medium
        ...
        },
        {
            ...
            // gpt 4o
            "{\n\"ReadingLevel\": 1,\n\"InappropriateLanguage\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"Security\": {\n\"Flag\": true,\n\"Instances\": [\n{\n\"Reason\": \"SQL injection\",\n\"Content\": \"' OR '1'='1'\",\n\"SuggestedReplacement\": \"\",\n\"Notes\": \"This is a classic example of an SQL injection attack. It should be removed or properly sanitized to avoid security vulnerabilities.\"\n}\n]\n},\n\"PoliticisedSentiment\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"PII\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"GrammarAndSpelling\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"StyleViolations\": {\n\"Flag\": false,\n\"Instances\": []\n},\n\"Summary\": \"The content contains a serious security issue with an SQL injection vulnerability. It should be addressed immediately to prevent potential exploitation.\"\n}"
        },
        {
            // ! GDS style violations
            270879,
            // gpt 4o
