...
public class What_LanguageModel : ServicePageModel<WhatLanguageViewModel>
{
    ...
    //todo: how to handle same language, but different names
    //todo: check list - generated by ai from https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes#References
    public static SelectListItem[] StaticLanguageOptionsIso639 { get; set; } =
    {
...
//new() { Value = "bh", Text = "Bihari languages" },
...
new() { Value = "el", Text = "Greek, Modern (1453-)" },
...
new() { Value = "ia", Text = "Interlingua (International Auxiliary Language Association)" },
new() { Value = "id", Text = "Indonesian" },
new() { Value = "ie", Text = "Interlingue; Occidental" },
//todo: some missing here / ordering changes
...
new() { Value = "nd", Text = "Ndebele, North; North Ndebele" },
new() { Value = "ne", Text = "Nepali" },
new() { Value = "ng", Text = "Ndonga" },
new() { Value = "nb", Text = "Bokmål, Norwegian; Norwegian Bokmål" },
new() { Value = "nn", Text = "Nynorsk, Norwegian; Norwegian Nynorsk" },
new() { Value = "no", Text = "Norwegian" },
new() { Value = "ii", Text = "Sichuan Yi; Nuosu" },
new() { Value = "nr", Text = "Ndebele, South; South Ndebele" },
new() { Value = "oc", Text = "Occitan (post 1500)" },
new() { Value = "oj", Text = "Ojibwa" },
new() { Value = "om", Text = "Oromo" },
new() { Value = "or", Text = "Oriya" },
new() { Value = "os", Text = "Ossetian; Ossetic" },
new() { Value = "pa", Text = "Panjabi; Punjabi" },
new() { Value = "pi", Text = "Pali" },
new() { Value = "fa", Text = "Persian" },
new() { Value = "pl", Text = "Polish" },
new() { Value = "ps", Text = "Pushto; Pashto" },
...
new() { Value = "st", Text = "Sotho, Southern" },
